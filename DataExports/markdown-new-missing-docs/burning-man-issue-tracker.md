...
### Context:
[~50% of Mongolians live in the capital, Ulan Bator. A large yurt village, called the Ger district, surrounds the official city. which is very cold in the winter. Yurt dwellers burn coal to survive. See: also: Issue Graph](https://ideapad.io/mongolia-issues/graph?snapshot=infrastructure-and-more)

### Good Initiatives
- [Gerhub](https://gerhub.org/) – finding innovative solutions to pressing issues in the ger areas

- Needs: philanthropic funding, engineering talent?

- Initiative to apply to college in USA - similar to Skillshare [To find URL]

- Needs: ??

- #idea HackMongolia -- no large scale hackathons in Mongolia #idea ~Battushig

- Needs: sponsors, mentors

- #idea LLMs to translate MOOCs into the Mongolian language
...
- NOVAx
- TomyoEdtech
- [Login • Instagram — https://instagram.com/tomyoedtech?igshid=MzRlODBiNWFlZA==](https://instagram.com/tomyoedtech?igshid=MzRlODBiNWFlZA==)
- [Login • Instagram — https://instagram.com/novax.space?igshid=MzRlODBiNWFlZA==](https://instagram.com/novax.space?igshid=MzRlODBiNWFlZA==)
-
...
-
##### Youth want more access to quality tech education #UntappedPotential
...
#### Opportunities
-
##### Recently modernized ecobuses/electric buses in city center

-
##### Mongolia has recently gained wider cell data infrastructure.

-
##### Mongolia has strong and effective protest culture/free speech

#### “Wicked Problems” / Long term Challenges
-
##### Air pollution from coal burning (largely for yurt heating)
...
-
##### Poor water drainage in summer → flooding when heavy rain #SeasonalIssues
...
-
##### Outdated energy infrastructure - coal power plants outdated; wanting energy independence

- dependent on Russia for energy

-
##### Transportation expensive from Ger districts – hard to get into city center
...
-
-
##### Food prices have gone up since Ukraine war
...
-
##### Poor infrastructure / city planning; lack of roads / paths; not easily walkable →  everyone has cars

- traffic jams all year long

-
##### Hard for people with disabilities (e.g. wheelchair, or hearing/sight problems) to get around

- <relates to> poor infrastructure

-
##### Category: #SeasonalIssues

-
##### [New issue: edit me; click > on left to expand/collapse]
...
#### “Low-Hanging Fruit” Problems
-
##### [Widespread pharmaceuticals contributes to mental health challenges[a]](#cmnt1)

- Wider variety of ways to take breaks
- [Promote embodied well-being practices and make them accessible and fun http://qigong.garden/](http://qigong.garden/)
- Related: screen addiction

-
##### Epidemic back pain

- [Svaroopa Yoga](http://svaroopa.org) Is not well known can potentially address the epidemic of back pain

-
##### Gen Z is bored by corporate life & sees potential for it to be more playtested
...
-
##### Food deserts - in poor urban areas, in native american reservations

- http://actualfood.com/

-
##### Public schooling not effective in many places
...
-
##### Need for more emotional / contemplative public education
...
- Games for low vision kids

- [Adrian Rodriguez co](https://www.ted.com/tedx/events/50559)
...
#### Opportunities
-
##### Lots of great embodied healing arts teachers created content online over COVID

-
##### Chinese medicine/acupuncture/qigong is Understudied/not well known in the West and can potentially help physical and emotional problems

- [Svaroopa Yoga](http://svaroopa.org) Is not well known can potentially address the epidemic of back pain

#### “Wicked Problems” / Long term Challenges
-
##### Political Polarization (NVC could help bridge the gap and get both sides to understand where each other are coming from, and stop talking past each other)
...
-
##### Widespread sense of lack of meaning “meaning crisis” (related to postmodernism)

- Culture that worships money vs empowerment of others
...
-
##### lacks the financial incentive for pharmaceutical companies to spend large amounts of money figuring out and solving.

- [Personalized medicine like research to the people](https://www.researchtothepeople.org/) could be useful for n=1 experiments based on a person’s genome

- Ehlers Danlos Syndrome (TNXB, Vascular)
-
- [Potential Solution: Stanford rare disease hackathon https://rttp.stanford.edu/](https://rttp.stanford.edu/)
...
- Highly polluted water supply (see difference between places closer to mountain water sources vs near the coast)
...
- [‘America, world police’ is the wrong vibe. United Nations is directionally correct. Global civilization of sharing, caring, and love is the right vibe. Need to find a way to co-exist despite competing ideologies, for starters we need to ALL agree on basic human rights](https://en.wikipedia.org/wiki/Universal_Declaration_of_Human_Rights). Ideally try very very hard to exhaust non-violent means of coalescence on agreeing to basic human rights.
...
- [Mongolia Issues](https://ideapad.io/mongolia-issues/graph?snapshot=infrastructure-and-more)
- [(See root level relations: https://ideapad.io/world-issue-trackers-issuetracker-gestaltlist/](https://ideapad.io/world-issue-trackers-issuetracker-gestaltlist/))
...
[Meta doc: Gestalts.world](http://gestalts.world)
- http://worldproblems.jacobcole.net/
- http://easilysolvableworldproblems.jacobcole.net/

[Notion for this project](https://www.notion.so/The-Issues-Tracker-for-World-Division-09b4b6f2be2a47959e21d753279c10d8?pvs=4)
...
[[a]](#cmnt_ref1)this makes no sense