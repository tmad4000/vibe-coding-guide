...
[started by jcol e @mit.edu , jacobcole.net](http://jacobcole.net)
...
- [gestaltbox.tk Suggestion Box Platform (live instance jcr.stcatz.ox.ac.uk/ideas/](http://jcr.stcatz.ox.ac.uk/ideas/)a well-used, smart suggestion box for St Catherine’s College Oxford. Student government is now required to respond to suggestions)
...
- Talks
- [TedX Oxford I gave on the project (video soon) Script Slides](https://docs.google.com/presentation/d/1j8SxykFkq9E_AqiOWqm-HDsTQAFJQdq2JgEzyLmoXwY/edit#slide=id.g2a65741b7_02)
...
- [Collaborative Ideation platform http://ideaflow.meteor.com/ alpha. For hackathons http://ideaflow.meteor.com/hackathon](http://ideaflow.meteor.com/hackathon)
...
- [Todo: integrate ConceptNet based Automatic idea-linking algorithm (paper below, demo](http://ec2-54-200-59-39.us-west-2.compute.amazonaws.com:5000/ui) on hackathonprojects.tk dataset)
...
- [Meteor ideaflow collaborative ideation platform (version0.2 , version 0.3 alpha](http://ideaflow.meteor.com/))
...
- [IdeaOverflow idea matching algorithm paper , the basis for a platform for collaborative ideation and project sharing; Society of Mind Final Project Writeup 1.1 . (Live demo](http://ec2-54-200-59-39.us-west-2.compute.amazonaws.com:5000/ui?query=app%20that%20suggests%20what%20you%20should%20cook)!)
...
- [Bite-sized AngelHack IdeaOverflow Project (prototype](http://pacific-tundra-3629.herokuapp.com/))
...
- [HackNY/HackPrinceton IdeaOverflow Project - ( prototype_old](http://agile-ocean-3244.herokuapp.com))
- [PHP Version 0.9 (see also PHP Version 0.8](http://instadefine.com/IdeaOverflow/idealisttest/index.1.3.php))
- [M ockup: IdeaOverflow IDE and Dashboards for Government](https://docs.google.com/file/d/0B-pHhDIV_JyBRE9fSThIUEhwNkU/edit)
- [*MIT iCampus Prize Entry * / Sup er UROP Proposal](https://docs.google.com/document/d/1u0ngxt6Jn0IttTckaUI8CT3DyNecJbI6aRV8q-Bwrnw/edit)on PoliticalProgressBar proj. Mentored by MIT Prof. Danny Weitzner, former White house CTO for Internet Policy. Currently implementing in partnership with MIT UA, Sloan Senate, and DSL of the administration
...
- [VisionCharter Idea Graph (v2 alpha](http://instadefine.com/IdeaOverflow/ATTHackathon/git/IdeaOverflow/IdeaGrapherFishEye3/11-30-12/VisionCharter0.5.htm)-- w/ adding nodes)
...
- [Press http://dailynews.co.tz/index.php/features/po pular-features/21246-telehackathon-internet-untapped-potential](http://dailynews.co.tz/index.php/features/popular-features/21246-telehackathon-internet-untapped-potential)

- http://hackmode.tk/ button
- [ProjectEvolution Timeline. Github](https://github.com/tmad4000/TruonexHackathon)
...
[[2. PoliticalProgressBar and SuggestionBox][d]](#cmnt4)
