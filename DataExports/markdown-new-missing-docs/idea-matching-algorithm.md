...
[[Next we implemented two basic algorithms for matching ideas, based on theories I and IV in Section 2.2. To test them we created a command-line interface from[c]](#cmnt3)[d]](#cmnt4) which the user can do simple things such as add ideas, add relationships, see suggestions of relationships, and make categories. (This is still under development and hence not yet integrated with the web interface.)
...
[[a]](#cmnt_ref1)cc
[[b]](#cmnt_ref2)bookmark Oct 5. 6:26 p.m.
[[c]](#cmnt_ref3)typo
[[d]](#cmnt_ref4)haha where did you find the link from?