...
[Fun Quickstart Guide: Ideaflow.app Draft 2020-12-15:](#h.wi7pm9prck2k)
[(Old) About Thoughtstreaming: Quick Intro](#h.xe8tqajt12am)
[Lowest friction interface to your brain](#h.pzbdlbpxdpz0)
[Older Thoughts](#h.gc60cjptdbd1)
[Desktop Rough Thoughtstream Filtering Tool](#h.39qjdi8jgfwu)
[Pre-alpha Prototype Demos](#h.h4mw4rcuvfjq)
[Features of a smart thoughtstreaming app](#h.880tt8diwz5u)
[Mockup](#h.s5lx1lju7epj)
[Detailed UROP Proposal](#h.le1yhid100ov)
[Facebook and twitter as implementing pieces of the thought stream vision](#h.s4mojofjdipv)
[Brainstorms on thoughtstreaming](#h.62zzztomw8e)
...
# [(Old) About Thoughtstreaming[a]](#cmnt1): Quick Intro
...
[[[[[[[[I call it Thoughtstreaming[b]](#cmnt2)[c]](#cmnt3)[d]](#cmnt4)[e]](#cmnt5)[f]](#cmnt6)[g]](#cmnt7)[h]](#cmnt8)[i]](#cmnt9).
...
<> Means relates to. To specify the nature of a relation (future) simply put it in the angle brackets. Eagerpanda.com <Investor> Charlie Cheever  
...
[[Your notes are a data structure and has properties like insertion time to create a new note. Just like any other  data structure you encounter in computer science, you need to think about how populating the data structure is going to affect that insertion time.  With the Thoughtstream approach (especially with the tools I intend to build on top of it[m]](#cmnt13)), it’s no harder to  scribble down a new note and tag it #idea  when you have 100 categories than 2  categories.[n]](#cmnt14) The experience doesn’t degrade over time.
...
[Use this tool to filter your notes by hashtags https://tmad4000.github.io/LiveLog/LiveLog1.5.htm](https://tmad4000.github.io/LiveLog/LiveLog1.5.htm)
Download Raw file and open in browser locally, then copy-paste in your thoughtstream

[Alpha: Thoughtstream mobile app.  Off-line only v0.1 https://itunes.apple.com/us/app/thoughtstream/id1330828366?mt=8](https://itunes.apple.com/us/app/thoughtstream/id1330828366?mt=8)

## Pre-alpha Prototype Demos
[Web http://cortexel.us/thoughtstream/](http://cortexel.us/thoughtstream/)
[iOS Smart notetaking app (under dev) app.thoughtstream.jacobcole.net](http://app.thoughtstream.jacobcole.net)
...
[Even in just a plain text editor, I haven't found a more natural syntax for noting thoughts I want to remember, and I have converted many friends and advisers to it (e.g. finnergarden.wordpress.com](http://finnergarden.wordpress.com/); moreover, other friends and started logging the thoughts with similar syntax completely independent of me.
...
[a) recognizes @ signs and sends entries marked with them to the appropriate suggestion box on the ideajoin.com](http://ideajoin.com)website. (Future: @facebook would post your Facebook wall, @blog to your blog, etc. You could send information to any application. This way)
...
[I wrote everything in etherpads like this http://sync.in/informationAgeExistentialist](http://sync.in/informationAgeExistentialist)
...
[Which is very similar to how http://hackathonideas.tk/](http://hackathonideas.tk/) is set up at the moment
...
6. I'm chatting with someone online
...
[And this is what my friends Sean Manton and LJ Rich have started doing. They use ChaosNotes to talk to each other as their primary form of communication. Fascinating! http://cortexel.us/chaos/?glitch](http://cortexel.us/chaos/?glitch) I asked them to make a list of demands. They were:
...
8. I have a recording of conversation or monologue (or speech-to-text isn't reliable in my environment)
...
9. I have 20 untranscribed journals of ideas.
...
[[a]](#cmnt_ref1)Been watching this app take form https://streams.supply/

Creator: https://twitter.com/vidythatte/status/1152404677197086721
[[b]](#cmnt_ref2)I've also been settling onto a personal convention of note taking where everything is a "log". Still exploring the full potential/realization of this idea, but it feels very similar to thoughtstreaming
[[c]](#cmnt_ref3)like for example, yesterday i made an "idea" log text file. I have logs for many things, including one main everything log dump for a day. I had not thought about using one file for all the logs tho!! Excited to play around with the idea
[[d]](#cmnt_ref4)i would like to try this with https://dat-tiddlywiki.glitch.me/
[[e]](#cmnt_ref5)tell me more!
[[f]](#cmnt_ref6)tw is by https://twitter.com/Jermolene and he calls it an "exoskeleton for your brain".  https://twitter.com/jimpick is working w/ the DAT project to make a multiwriter option, using tiddlywiki as a trial space, and I love the idea. there's a learning curve and the multiwriter is new, but just give it a try.
...
[[g]](#cmnt_ref7)if we could make tw easier for non-devs (like me) to use, it might be a wonderful back end for this project
[[h]](#cmnt_ref8)_Marked as resolved_
[[i]](#cmnt_ref9)_Re-opened_
[[j]](#cmnt_ref10)This is site blank for me
[[k]](#cmnt_ref11)something similar could be done with twitter!
[[l]](#cmnt_ref12)this is a future feature, inspired by the Gellish  formal language syntax https://en.wikipedia.org/wiki/Gellish and semantic web ideas like https://en.wikipedia.org/wiki/Turtle_(syntax)
[[m]](#cmnt_ref13)Take a lot this app. [http://threadnote.com/
[[n]](#cmnt_ref14)So are you suggesting that the main difference is that with something like evernote you have to decide the category before you start writing the note, but that you don't with thought streaming? But don't most of your thought streams start with the "category"/hashtag right away (would be my guess)? [Just trying to probe to tease apart what's actually going on here. Agreed that there's a huge difference between something like thought streaming and something like evernoting]
[[o]](#cmnt_ref15)oh wow. the social aspect feels killer
[[p]](#cmnt_ref16)there could also be a #public hashtag for stuff to be filtered into a public version
[[q]](#cmnt_ref17)https://speakeasy.org/~lion/nb/book.pdf except that the link does not seem to work; other sites reference this.
[[r]](#cmnt_ref18)A reviewer of the book at GoodReads says the book covers a lot of the same materials in the book The Tinderbox Way