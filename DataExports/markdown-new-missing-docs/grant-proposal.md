...
## Introduction
[I believe that there is no better way to learn something than spending time with people who are doing it for fun. The story of this project begins over a year ago when, after the incredible 2012 Greylock Hackfest hackathon in San Francisco, I found myself inspired to write a blog post <www.jacobblog.tpclubs.com/2012/08/hackercasting-a-big-idea/](http://www.jacobblog.tpclubs.com/2012/08/hackercasting-a-big-idea/)> on what I saw to be a new paradigm for both programming and leadership education, which I affectionately named “HackerCasting.”
...
[The event will be run like past tele-hackathons (e.g. the AT&T London-MIT hackathon ) and be geared towards people who can already program who build websites, apps, and the like. Leading up to the event, participants in both the US and Tanzania would join the Facebook Group for the event and start to discuss ideas for projects they want to work on. We would all also enter our personal skills, interests, and ideas into a central database (I've written a web platform to facilitate this. I additionally want to share an informal collaborative Google document in which my friends and I brainstorm our project ideas. http://hackathonprojects.tk/](http://hackathonprojects.tk/)).
...
[[[“Why is programming awesome?” <http://whyisitawesome.wikispaces. com](http://whyisitawesome.wikispaces.com/Programming)[a]](#cmnt1)/Programming](http://whyisitawesome.wikispaces.com/Programming)>
