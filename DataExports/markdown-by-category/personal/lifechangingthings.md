...
[systematicawesome.jacobcole.net > lifechangingthings.jacobcole.net](http://lifechangingthings.jacobcole.net)
...
[See also:quoteslist.jacobcole.net •whyisitawesome.jacobcole.net •Excellent Books (Jacob + Friends Curated) • Jacob’s Raw Books List • lifechange.jacobcole.net](http://lifechange.jacobcole.net)
...
[#book Religiousness in Yoga ~Desikachar. Preview:  http://yoga.jacobcole.net](http://yoga.jacobcole.net/)

Tags:, book, Understanding, Zen, ~Benjamin, Radcliffe, ExplainingMeditation, WhyAwesome:, zen
...
Tags:, word, concept, Sonder

Tags:, activity, Learning, to, surf, →, my, first, meditation., Made, me, more, calm, ~Jacob

[#VideoGame https://robocode.sourceforge.io/ –  Fun way to learn to program, to do trig, etc. http://robocode.jacobcole.net](http://robocode.jacobcole.net/) ~Jacob
