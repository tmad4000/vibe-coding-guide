...
[If you need to get in touch with someone, feel free to email jacob+systematicawesome@ideaflow.io](mailto:jacob+systematicawesome@ideaflow.io)

Graphen Protocol - Distributed, decentralized graph database (DLT)
        Looking for CTO, ideally with distributed systems and cryptography experience/deep knowledge
        Investors to join an anchor investor or even potentially lead the investment round
...
Blockchain game developers who want to build on –– Amazing Blocks
Oren Bennett
[oren@keth.iO](mailto:oren@keth.iO)

Hashed –
Good ICO projects and acceleration candidates
People with traditional VC experience
investment@hashed.com

Quantstamp -- Krishna Sriram
         People looking for security audits, people looking for regional channel partner

Kunyi Li
        People needing a friend at 3 in the morning

Kingsley Advani - Chainfund
        Looking for: Korean exchange partnerships – korbit?

Eric Lamison-White - Pareto Network:
Looking for content contributors/Intel providers
Looking for positive engagement with regulators
eric@pareto.network

TN Lee – kyber go:
Looking for: people doing ICOs

Don Ho – quantstamp:
Looking for: People needing ethereum security audits

Sam Trautwein – carbon.money:
Looking for: ethereum security audit

StatX (mobile app: better telegram for updating crypto community):
Looking for: 5 star reviews

Dorahacks/Hackerfund (BA Capital):
US Crypto Investment Scout (full time)  #hiring
High quality Early stage crypto projects to invest in

X-Capital
High quality Early stage crypto projects to invest in

JC Xu - Early Investor of VEN, 0x, ICON, Zilliqa
        Looking for: meeting excellent entrepreneurs and investors

Do Kwon - Terra
        Looking for: Economists, data scientists, engineers with experience building payment systems

Jeremy Rubin -- Advisor to Lightyear.io (Stellar), Bitcoin Core Developer, previously founded MIT DCI
        Looking for early stage companies/individuals looking for investment + strategic advising
                Focused on non-dapp projects, but willing to chat about anything
        Engineers wanting full time work on Stellar

High quality early stage crypto projects:

http://abacusprotocol.com/ (no token sale) #YCombinator

[Omar Diab #brilliantEngineer[a]](#cmnt1) #workingOnProject

Autonomi.io #Hiring

# Crypto Companies that are Hiring

[See also: hiringlist.jacobcole.net](http://hiringlist.jacobcole.net)
...
We’ve raised $1.8M and have >$200k/yr revenue from major customers such as Silicon Valley Bank while still being in private beta. The project has piqued the interest of Fields Medalist Tim Gowers (collaborative theorem proving pioneer) and NIST (National Institute of Standards and Technology). The long term plan, however, is to release our software as a personal knowledge base for everyone

We are small team, based in the San Francisco Bay Area (but may take remote), really like Typescript, and are one of the most intense ReactJS applications on the Web.

Ideaflow on Crunchbase

Demo:
ICO Ecosystem https://ideapad.io/blockchain-ecosystem/graph?snapshot=icoconducted-ecosystem
...
- Community Growth (full-time/part-time)

- We’re a remote-first company, but have an office in SF if easier

# Seeking Employment

-
### Diego Roque (MIT, IMO/IOI Gold Medalist, Haskell)

- Looking for part-time Haskell jobs in the Bay area or remote
- MIT Mathematics major
- Experience in functional programming languages
- Some ML/AI experience
- IMO/IOI Gold
- [Resume: http://diegoroque.me/resume.pdf](http://diegoroque.me/resume.pdf)

-
### Amit Panghal (NYU, IIT Bombay, IChO medallist)

- Looking for full time role sometime in future
- Interested in distributed systems and security
- Go, C++
- panghalamit1892@gmail.com

[[a]](#cmnt_ref1)I can attest to this -- he did some contracting for us at IdeaFlow.io