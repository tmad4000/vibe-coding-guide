...
- [Feel free to ping jacob@ideaflow.io](mailto:jacob@ideaflow.io) w questions – my dad is a sleep researcher

- Experiments as a way to learn. Sharing what we’ve run, results
- How to manage (physical) pain to learn better faster

- https://effectivealtruismcoaching.com/blog/2020/10/31/being-productive-with-chronic-health-conditions
...
- [Shane Parrish’s Farnam Street is a gold mine -- https://fs.blog/how-to-read-a-book/](https://fs.blog/how-to-read-a-book/)

- 4 levels of reading. Syntopical reading most effective for comprehensive understanding of a subject

- [Pdfdrive](https://www.pdfdrive.com/): search engine for PDF files
- [Libgen](https://librarygenesis.net/): digital library
- [OpenSyllabus](https://opensyllabus.org/): curriculums to get started on learning any subject
- [Hypothesis app](https://web.hypothes.is/) for collaborative annotation. Structured communal mode. Everyone marks a line in a PDF with questions while going along.
- [Feynman Technique](https://strategyumwelt.com/frameworks/feynman-technique)

#### Recommended books:
- [Bookslist.jacobcole.net](http://bookslist.jacobcole.net/)
- [[[[Jacob Cole] T. K. V. Desikachar’s classic intro to yoga (first 6 pages at http://yoga.jacobcole.net/](http://yoga.jacobcole.net/)). Religiousness in Yoga: Lectures on Theory and Practice](https://openlibrary.org/works/OL894546W/Religiousness_in_yoga?edition=isbn_9780819109675). Extremely lucid outline on the path to transcendence – not actually about religiousness. Transcendence in the spirit of “To transcend motion and stillness is the highest meditation](https://www.wayofbodhi.org/bodhidharma-quote-generosity-n-meditation/)” ~Bodhidharma
- [[Minn Kim] How Buildings Learn, Stewart Brand](https://www.amazon.com/How-Buildings-Learn-Happens-Theyre/dp/0140139966)
- [[Spencer] The World Until Yesterday, Jared Diamond](https://www.amazon.com/World-Until-Yesterday-Traditional-Societies/dp/0143124404)
- [[Rebecca] Revolt of the Public, Martin Gurri](https://www.amazon.com/Revolt-Public-Crisis-Authority-Millennium/dp/1732265143)
- [[Pam Rollin] The Timeless Way of Building, Christopher Alexander](https://www.amazon.com/Timeless-Way-Building-Christopher-Alexander/dp/0195024028)
- [[Jai] Enlightenment: The Damnedest Thing, Jed McKenna](https://www.amazon.com/Spiritual-Enlightenment-Damnedest-Thing-Trilogy/dp/0980184843/ref=sr_1_1?crid=1Q0CW0F544H8N&dchild=1&keywords=enlightenment+the+damnedest+thing&qid=1611537795&sprefix=enlightenment+the+damn%2Cstripbooks%2C219&sr=8-1)

#### Recommended reads:
- [Designing the web to be a place for people, beyond information. Future of Web Annotation by Linus Lee https://thesephist.com/posts/hypertext/](https://thesephist.com/posts/hypertext/)
...
#### Recommended resources:
- [Jeremy’s notes on compressing content](https://docs.google.com/document/d/154kd5BSUSipuTx34Kv_CZseih-5foAC2dS4efX5CX3Q/edit?fbclid=IwAR03pjlvAK1deFfaph3qIXiDWE_0_H5rrm5Xa1j0gazuDd6ELdo7u-P_jo8)
- Deliberate practice: examples in sports, music

- Slowing down really important
- Anticipating errors

- [Journal clubs](https://twitter.com/eugenewei/status/1108249120441946112)
- [Fermat’s Library extension](https://fermatslibrary.com/librarian) for arXiv papers. Communal learning from experts
- [Reading groups](https://muratbuffalo.blogspot.com/2015/05/how-to-run-effective-paper-reading.html) need three things to be successful:

- Participants need to come prepared
- Presenter should be prepared
- Make/produce something during the discussion for most effective engagement

- Active vs passive learning
- Retros

#### Raw Notes
- When was the last time you were trying to learn something new?

- Where to begin?
- Set a specific goal and work backwards
- How to run a good retro?

- How to know when you’re ready to move onto a next phase? When to go from learning the basics to advancing?

- Ariel learning tennis. Immersive learning

- Visual practicing for activating mirror neurons. Watch an expert play piano/violin/tennis

- Mark on feedback loops on subcomponents

- Facilitate introspection
- Feedback loops are self sufficient

- How to focus attention and achieving tasks
- Complice.co. Jayanth’s rec. Pomodoro

- FocusMate, holds accountability

- How to learn well? Inspire myself?
- Time constraints. Measure how long a page takes to read. Can plan ahead better.
- Brainscape vs. Anki decks vs. Supermemo

- http://www.marknagelberg.com/spaced-repetition-newsletter/
- http://www.marknagelberg.com/anki/anki_webpage_loaded.html

- Forgetting curve

- Practice recalling and amount of time to forgetting lengthens
- Recap questions in textbooks

- How to decide what is an atomic unit of info (e.g., in an Anki deck)?
- Mode of processing :

- Remember visually/spatially “see the words in my mind” The memory palace
- Remembering while distracted
- Remembering in a contextual environment. Imagine when you might need the knowledge

- Book rec: Metaphors we live by
...
- [Learning by analogy. Analogy as core to cognition](https://www.youtube.com/watch?v=n8m7lFQ3njk), Douglas Hofstadter
...
- [Jacob’s book rec: Stealing Fire](https://www.amazon.com/Stealing-Fire-Maverick-Scientists-Revolutionizing/dp/0062429655)
- Ecstatic technology
- OODA loop
...
- Andrew Huberman
- [Homolateral crossover technique (a bit like self-EMDR) https://www.youtube.com/watch?v=hBvpDfWqL1s](https://www.youtube.com/watch?v=hBvpDfWqL1s)

[Do it 3 or 4 times if you’re stuck and really want to spread the wildfire of integration across your brain. Also you need to be ready to mentally let go in the process, or it will mostly just feel vaguely unpleasant! #mentalstatehack http://mentalstatehacks.jacobcole.net/](http://mentalstatehacks.jacobcole.net/)
...
[This guy may be relevant, met him a few years back ~Jacob https://www.youtube.com/watch?v=TZwvnBAddjw](https://www.youtube.com/watch?v=TZwvnBAddjw) Compassionate AI with Mohamad Tarifi
...
[“Tulpas”, the ego as an imaginary friend https://www.facebook.com/n0logik/posts/3729008590522068](https://www.facebook.com/n0logik/posts/3729008590522068)
“Tulpas”
