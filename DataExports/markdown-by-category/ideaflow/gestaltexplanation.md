...
# Notes on Gestalts
[Since this paper was written, IdeaOverflow IDE has evolved into a larger mission, Ideaflow](https://ideaflow.io/). The ultimate goal of Ideaflow is to build a Gestalt processing system for society. We make the hypothesis that, dual to Minsky's Society of Mind Theory, wherein mind is as a collection of unthinking agents and a system to mediate between them, that a mind is a Gestalt processing system. Therefore, building a Gestalt processing system for society is equivalent to building a mind (which one might expect to have a consciousness, to have qualia, of its own). The second observation is that a society and any form of government already implicitly is a Gestalt processing system, albeit, not necessarily an effective one. (Defined as: it doesn’t mobilize its collective body to close gestalts effectively). So the global mind is already here, it is simply scatterbrained. We’d like it to help it become more integrated, meditative, and rigorous – all words which essentially refer to the same phenomenon.

[On Open Gestalts https://psycho-therapeut.ch/EN/gestalttherapie-e.htm](https://psycho-therapeut.ch/EN/gestalttherapie-e.htm)
- “An open "Gestalt" could be for example an unresolved conflict, an unfulfilled wish or an unprocessed traumatic experience.”

[On Gestalt Psychology https://en.wikipedia.org/wiki/Gestalt_psychology](https://en.wikipedia.org/wiki/Gestalt_psychology)
- The background in a piece of art is the closed gestalt: the attention skates over it
- The foreground is an open gestalt: that which tugs on your attention
- Attentional selection can change foreground and background as in Faces & Vases Illusion. Similarly, backgrounded observations can connect in our minds to tug on our attention.

Process the open gestalts in societies mind → heal the society mind.

Further directions to explore
- Buddhist concept of “emptiness” and all phenomena as gestalt phenomena
- Gestalts and their relation to Liebniz’ Monads

[See also: http://ideaflowbackground.jacobcole.net/](http://ideaflowbackground.jacobcole.net/)
